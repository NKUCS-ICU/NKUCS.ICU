...
>
> **3. 课程列表与2023级计科的培养计划对齐了！(目前部分新增课程的页面评论区没有初始化可能暂时不能评论，bug待修复) 将2023fall的课程评价均添加到页面内了！**
>
> 希望朋友们都不要进ICU。
...
2. 评论区需要使用Github授权登陆，第一次未登录可能会显示"尚未创建评论区"相关提示性话语。注意，**这不是因为没有评论**，而是这时需要"**科学上网**"或稍等一段时间后即可访问。\
如下图所示，点击"使用Github登录"即可:\
![示例](https://s3.bmp.ovh/imgs/2022/01/5e5db805da45127c.png)
