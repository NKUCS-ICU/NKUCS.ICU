...
本站的面向群体是计算机学院和网络空间安全学院的本科生，下简称 NKUCS。

和其他所有学院相同，任何课程中，既存在一些优秀的高质量课程，也存在不少滥竽充数的低质量课程。因此，本网站的存在，旨在记录所有课程的信息，以及历届学生对其的评价。
...
1. 投稿请至少写明投稿对象（如哪个课程，哪个比赛，哪个大厂的实习经历，哪个学校哪个实验室的推免经历）、投稿时间（课程修读学期、经历所在时间）、投稿人署名（可署Github名，如希望匿名可署Anonymous）、投稿具体内容。
...
3. 我们欢迎大家从多角度、多方面分享个人感受，共同建设一个良好的交互生态，为更多nkucs、甚至其他院校的同学带来帮助。
...
2. 评论区需要使用Github授权登陆，第一次未登录可能会显示"尚未创建评论区"相关提示性话语。这时需要**其他方式**或稍等一段时间后即可访问。
...
2021/12/21: \
加入了经验分享模块，包括但不限于以下相关信息，欢迎投稿至[维护人员邮箱](mailto:emanual20@foxmail.com)：
